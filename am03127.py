...
def encode_charset(unicode_str) :
  s = ''
  unicode_str = unicode_str.replace('Á', '{U41}')
  unicode_str = unicode_str.replace('É', '{U49}')
  unicode_str = unicode_str.replace('Í', '{U4D}')
  unicode_str = unicode_str.replace('Ó', '{U53}')
  unicode_str = unicode_str.replace('Ú', '{U5A}')
  unicode_str = unicode_str.replace('á', '{U61}')
  unicode_str = unicode_str.replace('é', '{U69}')
  unicode_str = unicode_str.replace('í', '{U6D}')
  unicode_str = unicode_str.replace('ó', '{U73}')
  unicode_str = unicode_str.replace('ú', '{U7A}')
  unicode_str = unicode_str.replace('Ñ', '{U51}')
  unicode_str = unicode_str.replace('ñ', '{U71}')
  unicode_str = unicode_str.replace('°', '{U3A}')
